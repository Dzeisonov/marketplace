    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildSettingsItem("Display", Icons.settings_display, _showDisplayDialog),
          _buildSettingsItem("Notifications", Icons.notifications, _showNotificationsDialog),
          ...
          _buildSettingsItem("Terms & Conditions", Icons.assignment_outlined, _showTermsConditions),
          _buildSettingsItem("Privacy Policy", Icons.privacy_tip_outlined, _showPrivacyPolicy),
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight: isDarkModeEnabled ? FontWeight.normal : FontWeight.bold,
                    ),
                  ),
                  SizedBox(width: 10),
                  Text(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight: isDarkModeEnabled ? FontWeight.bold : FontWeight.normal,
                    ),
                  ),
                ],
              ),
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              _buildFAQItem("Q: How long will my package take to arrive?", "A: Your package will arrive within a maximum of 3 days after payment."),
              _buildFAQItem("Q: Can I return items if they don't fit?", "A: Yes, you can return items within 7 days of delivery if they don't fit."),
            ],
          ),
        );
      },
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              "This application project was created by group 2 with the marketplace subtheme",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            SizedBox(height: 8), 
